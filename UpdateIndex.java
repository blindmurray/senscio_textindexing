...
public class UpdateIndex extends Indexer {
	...
	public static int writeIndexUpdate(String dataDirPath, FileFilter filter)
			throws IOException, TikaException, SAXException {
	...
	public static int writeIndexUpdate(String dataDirPath, String tokens, FileFilter filter)
			throws IOException, TikaException, SAXException {
		File convertedFile = null;
